...
#ifndef DC_SampleControlBlock_1_H
#define DC_SampleControlBlock_1_H
 ...
 * @version 1.0
 */
 #define TYPE_DC_SampleControlBlock_1 "dc_samplecontrolblock_1"
...
struct DC_SampleControlBlock_1 {
    DataPoolControlBlock parent;
};


struct DC_SampleControlBlock_1Class {
...
#define DC_SAMPLECONTROLBLOCK_1_GET_CLASS(obj) \
         OBJECT_GET_CLASS(DC_SampleControlBlock_1Class, obj, TYPE_DC_SAMPLECONTROLBLOCK_1)


#define DC_SAMPLECONTROLBLOCK_1_CLASS(klass) \
         OBJECT_CLASS_CHECK(DC_SampleControlBlock_1Class, klass, TYPE_DC_SAMPLECONTROLBLOCK_1)


#define DC_SAMPLECONTROLBLOCK_1(obj) \
         OBJECT_CHECK(DC_SampleControlBlock_1, obj, TYPE_DC_SAMPLECONTROLBLOCK_1)
