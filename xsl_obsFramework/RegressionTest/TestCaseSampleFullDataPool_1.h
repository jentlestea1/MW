...
struct TestCaseSampleFullDataPool_1 {
    TestCaseWithEvtCheck parent;
};


struct TestCaseSampleFullDataPool_1Class {
...
#define TESTCASESAMPLEFULLDATAPOOL_1_CLASS(klass) \
            OBJECT_CLASS_CHECK(TestCaseSampleFullDataPool_1Class, klass, TYPE_DC_SAMPLEFULLDATAPOOL)


#define TESTCASESAMPLEFULLDATAPOOL_1(obj) \
            OBJECT_CHECK(TestCaseSampleFullDataPool_1, obj, TYPE_TESTCASESAMPLEFULLDATAPOOL_1)
