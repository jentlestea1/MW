    ...
    if (has_op_complemented(devop->private_data, op_idx)){
         switch (op_idx){
               case GYROSCOPE_GETX_INDEX: 
                    result =  gdop->general_gyroscope_getx(devop->private_data, 
                                                           data); 
                    break;
               case GYROSCOPE_GETY_INDEX: 
                    result =  gdop->general_gyroscope_gety(devop->private_data,
                                                           data); 
                    break;
               case GYROSCOPE_GETZ_INDEX: 
                    result =  gdop->general_gyroscope_getz(devop->private_data,
                                                           data); 
                    break;
               case GYROSCOPE_GETXYZ_INDEX: 
                    result =  gdop->general_gyroscope_getxyz(devop->private_data,
                                                             data); 
                    break;
               default:
                    break;
