...
<xsl:text/>
<xsl:text>   </xsl:text>CC_FSM_setNumberOfStates((CC_FSM*)<xsl:value-of select="$fsm"/>,<xsl:value-of select="count(FsmState)"/>);
<xsl:text/>
           ...
           <xsl:if test="InitialEnableStatus">
                 <xsl:choose>
                       <xsl:when test="@value='ENABLED'">
                           <xsl:text>   </xsl:text>CC_FSM_setInitialEnabledStatus((CC_FSM*)<xsl:value-of select="$fsm"/>,true);
<xsl:text/>
                       </xsl:when>
                       <xsl:when test="@value='DISABLED'">
                           <xsl:text>   </xsl:text>CC_FSM_setInitialEnabledStatus((CC_FSM*)<xsl:value-of select="$fsm"/>,false);
<xsl:text/>
                       </xsl:when>
                       <xsl:otherwise>
            ...
            <xsl:for-each select="FsmState/Index">
                <xsl:text>   </xsl:text>CC_FSM_setState((CC_FSM*)<xsl:value-of select="$fsm"/>,<xsl:value-of select="@value"/>,<xsl:value-of select="../*[@kind='component']/@name"/>);
<xsl:text/>
            </xsl:for-each>
